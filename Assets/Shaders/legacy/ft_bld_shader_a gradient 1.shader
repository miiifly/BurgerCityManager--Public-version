...
Shader "Lichthund/FT Gradient4x4 "
{
	Properties
	{
		...
		[Toggle]_Color_1Emission("Color_1 Emission", Float) = 0
		[HDR]_Color_1("Color_1", Color) = (0,0,0,1)
		[Toggle]_Color_2Emission("Color_2 Emission", Float) = 0
		[HDR]_Color_2("Color_2", Color) = (0,0,0,1)
		[Toggle]_Color_3Emission("Color_3 Emission", Float) = 0
		[HDR]_Color_3("Color_3", Color) = (0,0,0,1)
		[Toggle]_Color_windowEmission("Color_window Emission", Float) = 0
		[HDR]_Color_window("Color_window", Color) = (0,0,0,1)
		[HideInInspector]_Texture0("Texture 0", 2D) = "white" {}
		_Hue("Hue", Range( 0 , 1)) = 0
		_Value("Value", Range( -1 , 1)) = 0
		_Saturation("Saturation", Range( 0 , 2)) = 1
		[Toggle]_ToggleWorldspacegradient("Toggle World space gradient", Float) = 0
		_GradientHeight("GradientHeight", Range( 0 , 20)) = 6.4
		_Gradientpower("Gradientpower", Range( 0 , 1)) = 1
		_Bottomcolor("Bottom color", Color) = (0.1698113,0.1465824,0.1465824,0)
		_Topcolor("Top color", Color) = (0.8416696,0.9076058,0.9245283,0)
	...
	SubShader
	{
		...
		uniform float _ToggleWorldspacegradient;
		...
		uniform float _Color_1Emission;
		uniform float4 _Color_1;
		uniform float _Color_windowEmission;
		uniform float4 _Color_window;
		uniform float _Color_2Emission;
		uniform float4 _Color_2;
		uniform float _Color_3Emission;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult858 = clamp( ( ase_worldPos.y / _GradientHeight ) , 0.0 , 1.0 );
			float4 lerpResult844 = lerp( _Bottomcolor , _Topcolor , clampResult858);
			float4 temp_cast_3 = (_Gradientpower).xxxx;
			float4 temp_cast_4 = (0.0).xxxx;
			float4 temp_cast_5 = (1.0).xxxx;
			float4 clampResult843 = clamp( ( float4( hsvTorgb821 , 0.0 ) * pow( lerpResult844 , temp_cast_3 ) ) , temp_cast_4 , temp_cast_5 );
			o.Albedo = (( _ToggleWorldspacegradient )?( clampResult843 ):( float4( hsvTorgb821 , 0.0 ) )).rgb;
			float4 lerpResult406 = lerp( float4( 0,0,0,0 ) , _Color_1 , temp_output_763_0);
			float4 lerpResult422 = lerp( float4( 0,0,0,0 ) , _Color_window , temp_output_761_0);
			float4 lerpResult479 = lerp( (( _Color_1Emission )?( lerpResult406 ):( float4( 0,0,0,0 ) )) , (( _Color_windowEmission )?( lerpResult422 ):( float4( 0,0,0,0 ) )) , (( _Color_windowEmission )?( lerpResult422 ):( float4( 0,0,0,0 ) )));
			float4 lerpResult410 = lerp( float4( 0,0,0,0 ) , _Color_2 , temp_output_638_0);
			float4 lerpResult498 = lerp( lerpResult479 , (( _Color_2Emission )?( lerpResult410 ):( float4( 0,0,0,0 ) )) , (( _Color_2Emission )?( lerpResult410 ):( float4( 0,0,0,0 ) )));
			float4 lerpResult414 = lerp( float4( 0,0,0,0 ) , _Color_3 , temp_output_746_0);
			float4 lerpResult499 = lerp( lerpResult498 , (( _Color_3Emission )?( lerpResult414 ):( float4( 0,0,0,0 ) )) , (( _Color_3Emission )?( lerpResult414 ):( float4( 0,0,0,0 ) )));
...
/*ASEBEGIN
Version=18703
150;92;2044;1080;1415.935;1523.242;1.681903;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;304;-6185.646,2850.342;Inherit;True;Property;_Texture0;Texture 0;64;1;[HideInInspector];Create;True;0;0;False;0;False;b244e25c9803b6f4d94be225bf0b2516;b244e25c9803b6f4d94be225bf0b2516;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.SignOpNode;749;-2412,2770;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SignOpNode;767;-2362.717,6403.469;Inherit;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ColorNode;705;-2832.339,6172.362;Inherit;False;Property;_Corners;Corners;45;1;[HDR];Create;True;0;0;False;0;False;0.2392157,0.2509804,0.3058824,1;0.3607843,0.2627451,0.254902,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;817;-2565.044,7965.647;Inherit;False;Property;_Bonus_color_dGradient;Bonus_color_d Gradient;53;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;670;-2873.096,1936.379;Inherit;False;Property;_Window_frame;Window_frame;24;1;[HDR];Create;True;0;0;False;0;False;0.4627451,0.4196079,0.4117647,1;0.1886792,0.1506586,0.1253115,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;679;-2855.238,2956.677;Inherit;False;Property;_Window_decor2;Window_decor2;31;1;[HDR];Create;True;0;0;False;0;False;0.254902,0.07843138,0.0509804,1;0.254902,0.07843138,0.0509804,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;652;-2948.897,-598.9269;Inherit;False;Property;_Color_secondary2;Color_secondary2;12;1;[HDR];Create;True;0;0;False;0;False;0.3018868,0.1295667,0.1039516,1;0.3018868,0.1295667,0.1039516,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;651;-2919.033,-409.7373;Inherit;False;Property;_Color_secondary;Color_secondary;11;1;[HDR];Create;True;0;0;False;0;False;0.482353,0.172549,0.1254902,1;0.482353,0.172549,0.1254902,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;704;-2842.685,6000.69;Inherit;False;Property;_Corners2;Corners2;46;1;[HDR];Create;True;0;0;False;0;False;0.06666667,0.1019608,0.2470588,1;0.06666667,0.1019608,0.2470588,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;655;-2928.37,-8.134895;Inherit;False;Property;_Roof_primary2;Roof_primary2;16;1;[HDR];Create;True;0;0;False;0;False;0.4056604,0.1931351,0.1779548,1;0.4056604,0.1931351,0.1779548,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;719;-2849.433,7203.009;Inherit;False;Property;_Bonus_color_c2;Bonus_color_c2;52;1;[HDR];Create;True;0;0;False;0;False;0.08650766,0.2030972,0.2264151,1;0.08650766,0.2030972,0.2264151,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;816;-2577.432,7448.479;Inherit;False;Property;_Bonus_color_cGradient;Bonus_color_c Gradient;50;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;674;-2854.493,2359.793;Inherit;False;Property;_Window_rail2;Window_rail2;28;1;[HDR];Create;True;0;0;False;0;False;0.482353,0.2392157,0.2235294,1;0.482353,0.2392157,0.2235294,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;680;-2843.892,3128.349;Inherit;False;Property;_Window_decor;Window_decor;30;1;[HDR];Create;True;0;0;False;0;False;0.482353,0.2745098,0.2431373,1;0.2735849,0.0993681,0.1704102,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;623;-2993.063,-1417.953;Float;False;Property;_Color_primary2;Color_primary2;7;1;[HDR];Create;True;0;0;False;0;False;0.1607843,0.08345432,0.05098039,1;0.1607843,0.08345432,0.05098039,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;660;-2919.432,584.3476;Inherit;False;Property;_Roof_secondary2;Roof_secondary2;19;1;[HDR];Create;True;0;0;False;0;False;0.5377358,0.3786568,0.2358935,1;0.5377358,0.3786568,0.2358935,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;675;-2843.147,2530.319;Inherit;False;Property;_Window_rail;Window_rail;27;1;[HDR];Create;True;0;0;False;0;False;0.6235294,0.5333334,0.509804,1;0.3113208,0.2305536,0.2592992,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;808;-2561.937,2568.14;Inherit;False;Property;_Window_railGradient;Window_rail Gradient;26;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;671;-2884.442,1764.707;Inherit;False;Property;_Window_frame2;Window_frame2;25;1;[HDR];Create;True;0;0;False;0;False;0.4056604,0.2388922,0.2085707,1;0.4056604,0.2388922,0.2085707,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;709;-2859.355,6594.63;Inherit;False;Property;_Bonus_color_b2;Bonus_color_b2;49;1;[HDR];Create;True;0;0;False;0;False;0.1981132,0.1313635,0.08130118,1;0.1981132,0.1313635,0.08130118,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;724;-2841.549,7806.203;Inherit;False;Property;_Bonus_color_d2;Bonus_color_d2;55;1;[HDR];Create;True;0;0;False;0;False;0.2083148,0.125712,0.2358491,1;0.2083148,0.125712,0.2358491,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;654;-2898.506,181.0547;Inherit;False;Property;_Roof_primary;Roof_primary;15;1;[HDR];Create;True;0;0;False;0;False;0.5647059,0.5058824,0.5019608,1;0.3726456,0.3408153,0.3867925,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;725;-2830.203,7977.875;Inherit;False;Property;_Bonus_color_d;Bonus_color_d;54;1;[HDR];Create;True;0;0;False;0;False;0.3882353,0.3529412,0.4,1;0.3882353,0.3529412,0.4,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;659;-2889.568,774.5372;Inherit;False;Property;_Roof_secondary;Roof_secondary;18;1;[HDR];Create;True;0;0;False;0;False;0.6705883,0.6313726,0.5960785,1;0.6705883,0.6313726,0.5960785,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;624;-2987.028,-1250.158;Float;False;Property;_Color_primary;Color_primary;5;1;[HDR];Create;True;0;0;False;0;False;0.3098039,0.2078432,0.1764706,1;0.3098039,0.2078432,0.1764706,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;685;-2872.458,3724.577;Inherit;False;Property;_Bottom_primary;Bottom_primary;33;1;[HDR];Create;True;0;0;False;0;False;0.3098039,0.282353,0.2745098,1;0.255696,0.2618281,0.3207547,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;720;-2838.087,7374.681;Inherit;False;Property;_Bonus_color_c;Bonus_color_c;51;1;[HDR];Create;True;0;0;False;0;False;0.3490196,0.3921569,0.4,1;0.2481755,0.285287,0.3113208,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;809;-2597.886,3185.021;Inherit;False;Property;_Window_decorGradient;Window_decor Gradient;29;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;710;-2848.009,6765.302;Inherit;False;Property;_Bonus_color_b;Bonus_color_b;48;1;[HDR];Create;True;0;0;False;0;False;0.4,0.3686275,0.345098,1;0.4,0.3686275,0.345098,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;684;-2883.804,3554.905;Inherit;False;Property;_Bottom_primary2;Bottom_primary2;34;1;[HDR];Create;True;0;0;False;0;False;0.2924528,0.1755023,0.1420879,1;0.2924528,0.1755023,0.1420879,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;689;-2885.411,4179.988;Inherit;False;Property;_Bottom_secondary2;Bottom_secondary2;37;1;[HDR];Create;True;0;0;False;0;False;0.1603774,0.06191638,0.0537113,1;0.1603774,0.06191638,0.0537113,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;780;-2690.443,-1099.854;Inherit;False;Property;_Color_primaryGradient;Color_primary Gradient;3;0;Create;True;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;690;-2874.065,4350.514;Inherit;False;Property;_Bottom_secondary;Bottom_secondary;36;1;[HDR];Create;True;0;0;False;0;False;0.3607843,0.2627451,0.254902,1;0.1260235,0.1288485,0.1698113,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;664;-2877.423,1343.834;Inherit;False;Property;_Window;Window;21;1;[HDR];Create;True;0;0;False;0;False;0.8867924,0.8867924,0.8867924,1;0.8962264,0.8962264,0.8962264,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;805;-2641.46,792.9252;Inherit;False;Property;_Roof_secondaryGradient;Roof_secondary Gradient;17;0;Create;True;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;807;-2595.459,1956.055;Inherit;False;Property;_Window_frameGradient;Window_frame Gradient;23;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;811;-2603.045,4457.305;Inherit;False;Property;_Bottom_secondaryGradient;Bottom_secondary Gradient;35;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;665;-2907.286,1154.645;Inherit;False;Property;_Window2;Window2;22;1;[HDR];Create;True;0;0;False;0;False;0.2924528,0.2924528,0.2924528,1;0.2924528,0.2924528,0.2924528,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;694;-2843.571,4764.607;Inherit;False;Property;_Bottom_roofing_a2;Bottom_roofing_a2;40;1;[HDR];Create;True;0;0;False;0;False;0.1603774,0.05632995,0.04765932,1;0.1603774,0.05632995,0.04765932,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;803;-2606.813,-439.7986;Inherit;False;Property;_Color_secondaryGradient;Color_secondary Gradient;9;0;Create;True;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;815;-2580.479,6859.432;Inherit;False;Property;_Bonus_color_bGradient;Bonus_color_b Gradient;47;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;806;-2582.411,1372.406;Inherit;False;Property;_WindowGradient;Window Gradient ;20;0;Create;True;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;814;-2521.573,6282.541;Inherit;False;Property;_CornersGradient;Corners Gradient;44;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;812;-2559.303,4990.534;Inherit;False;Property;_Bottom_roofing_aGradient;Bottom_roofing_a Gradient;38;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;695;-2832.225,4936.279;Inherit;False;Property;_Bottom_roofing_a;Bottom_roofing_a;39;1;[HDR];Create;True;0;0;False;0;False;0.482353,0.3764706,0.3647059,1;0.6320754,0.6241248,0.6241248,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;700;-2842.07,5555.579;Inherit;False;Property;_Bottom_roofing_b;Bottom_roofing_b;42;1;[HDR];Create;True;0;0;False;0;False;0.6627451,0.4705883,0.4588236,1;0.1828052,0.3579181,0.3679245,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;699;-2853.562,5379.906;Inherit;False;Property;_Bottom_roofing_b2;Bottom_roofing_b2;43;1;[HDR];Create;True;0;0;False;0;False;0.4716981,0.2263928,0.2113741,1;0.4716981,0.2263928,0.2113741,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ToggleSwitchNode;813;-2579.61,5637.704;Inherit;False;Property;_Bottom_roofing_bGradient;Bottom_roofing_b Gradient;41;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;810;-2573.045,3778.305;Inherit;False;Property;_Bottom_primaryGradient;Bottom_primary Gradient;32;0;Create;True;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;804;-2575.882,249.2606;Inherit;False;Property;_Roof_primaryGradient;Roof_primary Gradient;14;0;Create;True;0;0;False;0;False;1;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;688;-2471.909,4208.425;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;838;347.2373,4600.65;Inherit;False;730.3268;510.8144;Create the world gradient;6;860;859;858;849;848;847;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;849;397.2363,4817.951;Float;False;Property;_GradientHeight;GradientHeight;71;0;Create;True;0;0;False;0;False;6.4;0;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;860;404.0361,4601.65;Float;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleDivideOpNode;859;711.1714,4616.961;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;847;672.8417,4991.461;Float;False;Constant;_Float6;Float 6;-1;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;848;675.206,4897.261;Float;False;Constant;_Float1;Float 1;-1;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;858;932.5646,4696.438;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;827;505.4083,3333.901;Inherit;False;Property;_Saturation;Saturation;67;0;Create;True;0;0;False;0;False;1;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;867;1293.866,5084.054;Float;False;Property;_Topcolor;Top color;75;0;Create;True;0;0;False;0;False;0.8416696,0.9076058,0.9245283,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;866;1326.118,4890.542;Float;False;Property;_Bottomcolor;Bottom color;73;0;Create;True;0;0;False;0;False;0.1698113,0.1465824,0.1465824,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;828;524.504,3645.704;Inherit;False;Property;_Value;Value;66;0;Create;True;0;0;False;0;False;0;0.19;-1;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;822;437.6403,3211.256;Inherit;False;Property;_Hue;Hue;65;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;419;988.0336,-1022.057;Float;False;Property;_Color_window;Color_window;63;1;[HDR];Create;True;0;0;False;0;False;0,0,0,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;403;-900.7568,-939.6703;Float;False;Property;_Color_1;Color_1;57;1;[HDR];Create;True;0;0;False;0;False;0,0,0,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;405;-250.6683,-995.0635;Float;False;Property;_Color_2;Color_2;59;1;[HDR];Create;True;0;0;False;0;False;0,0,0,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;406;-638.1111,-796.2024;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.LerpOp;844;1756.776,4870.955;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;865;1210.313,4531.026;Inherit;False;Property;_Gradientpower;Gradientpower;72;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;410;-422.8732,-375.841;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;411;127.3073,-930.4078;Float;False;Property;_Color_3;Color_3;61;1;[HDR];Create;True;0;0;False;0;False;0,0,0,1;1,1,1,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;864;1465.432,4375.197;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;478;1162.335,208.8741;Inherit;True;Property;_Color_1Emission;Color_1 Emission;56;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;470;1184.561,-25.1816;Inherit;True;Property;_Color_windowEmission;Color_window Emission;62;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ToggleSwitchNode;491;1183.925,455.2372;Inherit;True;Property;_Color_2Emission;Color_2 Emission;58;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;842;2212.237,4519.488;Inherit;False;918;182;Final Clamp, you can disable it or rise the max value if you want to produce values higher than 1 for HDR;1;843;;1,1,1,1;0;0
Node;AmplifyShaderEditor.LerpOp;414;410.0295,-557.2202;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;1,1,1,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;861;1792.165,4426.179;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ClampOpNode;843;2262.237,4569.487;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.CommentaryNode;840;849.8085,6000.732;Inherit;False;907.8201;534.3306;The same lerp for the Top Gradient Colors;3;857;855;846;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;874;-398.1882,4124.929;Inherit;False;730.3268;510.8144;Create the world gradient;6;887;886;885;884;883;882;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;875;753.0358,3830.721;Inherit;False;918;182;Final Clamp, you can disable it or rise the max value if you want to produce values higher than 1 for HDR;2;879;880;;1,1,1,1;0;0
Node;AmplifyShaderEditor.CommentaryNode;839;854.2065,5541.034;Inherit;False;897.6793;426.1704;Lerp the 2 Gradient Bottom Colors according to the above normals y vector;3;856;853;845;;1,1,1,1;0;0
Node;AmplifyShaderEditor.ToggleSwitchNode;497;1166.948,692.7553;Inherit;True;Property;_Color_3Emission;Color_3 Emission;60;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.CommentaryNode;837;302.6046,5198.634;Inherit;False;901.0599;287.59;Get World Y Vector Mask;4;854;852;851;850;;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.ClampOpNode;887;193.812,4220.929;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;884;-62.18829,4508.929;Float;False;Constant;_Float7;Float 6;-1;0;Create;True;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;885;-30.18829,4140.929;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;877;849.812,4108.929;Inherit;True;False;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;882;-350.1883,4332.929;Float;False;Property;_GradientHeight1;GradientHeight;1;0;Create;True;0;0;False;0;False;6.4;0;0;20;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;852;809.7284,5295.641;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;846;912.1277,6084.541;Float;False;Property;_Top_XZ;Top_XZ;4;0;Create;True;0;0;False;0;False;0.2569204,0.5525266,0.7279412,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;855;1515.726,6227.839;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;889;529.812,4508.929;Float;False;Property;_2color1;2color;13;0;Create;True;0;0;False;0;False;0.0471698,0.0471698,0.0471698,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;881;545.812,4092.929;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;880;1345.812,3852.93;Inherit;False;Property;_ToggleSwitch1;Toggle Switch0;74;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;886;-62.18829,4412.929;Float;False;Constant;_Float2;Float 1;-1;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;879;801.0358,3878.718;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;890;977.812,4300.929;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;876;593.812,4268.929;Inherit;False;Property;_Gradientpower1;Gradientpower;76;0;Create;True;0;0;False;0;False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;888;561.812,4316.929;Float;False;Property;_1color1;1color;10;0;Create;True;0;0;False;0;False;1,1,1,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GradientSampleNode;870;-1877.786,6166.957;Inherit;True;2;0;OBJECT;;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;417;770.007,-853.6953;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;412;425.4673,-934.0233;Float;False;Constant;_Emmision4;Emmision4;27;1;[HDR];Create;True;0;0;False;0;False;0,0,0,1;0.5566037,0.4122018,0.4410822,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;878;1169.812,4156.929;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldNormalVector;850;339.3824,5285.744;Inherit;False;False;1;0;FLOAT3;0,0,0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.TexturePropertyNode;833;599.896,2331.625;Inherit;True;Property;_Texture1;Texture 1;68;0;Create;True;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.LerpOp;863;1168.085,4356.851;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;856;1524.929,5648.039;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;854;990.9257,5302.341;Inherit;False;False;True;False;True;1;0;FLOAT3;0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;836;193.2103,2857.651;Inherit;False;Property;_Float0;Float 0;69;0;Create;True;0;0;False;0;False;0;0;0;4;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;845;901.2286,5758.342;Float;False;Property;_Bot_Y;Bot_Y;6;0;Create;True;0;0;False;0;False;0.3877363,0.5955882,0.188311,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;857;903.8236,6295.738;Float;False;Property;_Top_Y;Top_Y;2;0;Create;True;0;0;False;0;False;0.7259277,0.7647059,0.06185123,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.DynamicAppendNode;868;-1620.81,6281.421;Inherit;True;FLOAT4;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.AbsOpNode;851;610.3245,5297.841;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector3Node;869;-1630.681,6602.061;Inherit;False;Constant;_Vector0;Vector 0;72;0;Create;True;0;0;False;0;False;0,0,0;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;891;3246.495,5553.679;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;862;2214.058,3887.083;Inherit;False;Property;_ToggleWorldspacegradient;Toggle World space gradient;70;0;Create;True;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.GradientNode;871;-2051.388,6045.535;Inherit;False;0;2;2;1,1,1,0;1,1,1,1;1,0;1,1;0;1;OBJECT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;873;-1776.368,3940.009;Inherit;True;4;4;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;853;901.5297,5591.14;Float;False;Property;_Bot_XZ;Bot_XZ;8;0;Create;True;0;0;False;0;False;0.7058823,0.2024221,0.2024221,0;0,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WorldPosInputsNode;883;-334.1883,4124.929;Float;True;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;513;2574.806,3909.496;Float;False;True;-1;2;CustomGradientShaderGUI;0;0;Standard;Lichthund/FT Gradient4x4 ;False;False;False;False;False;False;False;True;False;False;False;False;False;False;False;False;False;False;False;False;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.CommentaryNode;841;1602.582,5158.264;Inherit;False;574.3599;190.4;Lerp the Bottom and Top Colors according to the world gradient;0;;1,1,1,1;0;0
...
WireConnection;859;0;860;2
WireConnection;859;1;849;0
...
WireConnection;844;0;866;0
WireConnection;844;1;867;0
WireConnection;844;2;858;0
...
WireConnection;879;1;886;0
WireConnection;879;2;884;0
WireConnection;890;0;888;0
WireConnection;890;1;889;0
WireConnection;890;2;887;0
...
WireConnection;856;0;853;0
WireConnection;856;1;845;0
WireConnection;856;2;854;0
...
WireConnection;862;0;821;0
WireConnection;862;1;843;0
WireConnection;873;2;683;0
WireConnection;873;3;688;0
WireConnection;513;0;862;0
WireConnection;513;2;499;0
ASEEND*/
//CHKSM=225824D476D90E6AF0D5655F969B0D93171F5020